...
(function() {
	 ...
	 */
	window.UEDITOR_HOME_URL = "/onLineStu/ueditor/";
	var URL = window.UEDITOR_HOME_URL || "/onLineStu/ueditor/";
	...
	window.UEDITOR_CONFIG = {
		...
		whiteList : {
			...
			video : [ 'autoplay', 'controls', 'loop', 'preload', 'src',
					'height', 'width', 'class', 'style','data-setup' ],
			source : [ 'src', 'type' ],
